...
const SignIn: React.FC = () => {
  ...
  React.useEffect(() => {
    if (!loading && user) {
      navigate('/home', { replace: true }); // Redirect to home if user is authenticated
    }
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-24 py-12 bg-linear-to-b from-black to-[#1a1a1a]">
          <div className="max-w-md w-full mx-auto">
            ...
            <form className="space-y-8">
              ...
              <button
                type="submit"
                className="w-full bg-[#4a6d7c] hover:cursor-pointer hover:bg-[#5a7d8c] text-white text-3xl font-bold h-16 rounded-xl mt-8 transition-all transform active:scale-95 shadow-lg"
              >
                Sign in
              </button>
